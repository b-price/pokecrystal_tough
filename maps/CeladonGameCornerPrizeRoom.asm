...
.MenuData:
	db STATICMENU_CURSOR ; flags
	db 4 ; items
	db "PIKA HI    {d:CELADONGAMECORNERPRIZEROOM_PIKACHU_COINS}@"
	db "POLYGON    {d:CELADONGAMECORNERPRIZEROOM_PORYGON_COINS}@"
	db "LEVITATE   {d:CELADONGAMECORNERPRIZEROOM_LARVITAR_COINS}@"
	db "CANCEL@"

CeladonGameCornerPrizeRoomGentlemanText:
	text "I wanted POLYGON,"
